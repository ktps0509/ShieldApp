...
@Component({
  selector: 'app-vaccine10-list',
  templateUrl: './vaccine10-list.page.html',
  styleUrls: ['./vaccine10-list.page.scss'],
})
export class Vaccine10ListPage implements OnInit {
  ...
  View(typeSend: string){
    this.router.navigate(['../tabs/library/vacine10/detail', { 'code': typeSend}]);
  }
