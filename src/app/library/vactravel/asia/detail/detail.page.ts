    ...
    return this.vacService.getVacByCode2(code).pipe(first())
      .subscribe(
        data => {
          ...
          if (this.VacDetail.vaccode == "P001") {
          ...
          else if (this.VacDetail.vaccode == "P002") {
          ...
          else if (this.VacDetail.vaccode == "P003") {
            ...
            this.Cost1 = "ราคา 3,000 บาท";
            this.Cost2 = "ราคาเข็มละ 700-2,000 บาท";
          }
          else if (this.VacDetail.vaccode == "P004") {
