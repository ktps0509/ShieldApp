...
@Component({
  selector: 'app-vaccine9-list',
  templateUrl: './vaccine9-list.page.html',
  styleUrls: ['./vaccine9-list.page.scss'],
})
export class Vaccine9ListPage implements OnInit {
  ...
  View(typeSend: string){
    this.router.navigate(['../tabs/library/vacine9/detail', { 'code': typeSend}]);
  }
