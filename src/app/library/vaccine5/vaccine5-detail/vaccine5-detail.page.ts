...
@Component({
  selector: 'app-vaccine5-detail',
  templateUrl: './vaccine5-detail.page.html',
  styleUrls: ['./vaccine5-detail.page.scss'],
})
export class Vaccine5DetailPage implements OnInit {
    ...
    return this.vacService.getVacByCode(code).pipe(first())
      .subscribe(
        data => {
          ...
          if (this.VacDetail.vaccode == "E001") {
          ...
          else if (this.VacDetail.vaccode == "E002") {
          ...
          else if (this.VacDetail.vaccode == "E003") {
          ...
          else if (this.VacDetail.vaccode == "E004") {
