      ...
      .subscribe(
        data => {
          ...
          if (this.VacDetail.vaccode == "A001") {
            ...
            this.Effect = "อาจเป็นแผลบริเวณที่ฉีด";
            ...
            this.Cost1 = "เข็มละ 1,500-2,500 บาท";
            this.Cost2 = "ฟรี"
            ...
            this.Cost1 = "เข็มละ 2,500-5,000 บาท";
            this.Cost2 = "เข็มละ 1,000-2,000 บาท";
          }
            ...
            this.After = "ควรให้ยาลดไข้เเละเช็ดตัวด้วยน้ำอุณหภูมิห้อง ส่วนบริเวณที่บวมให้ใช้วิธีประคบเย็น";
            this.Cost1 = "เข็มละ 900-1,500 บาท";
            ...
            this.Descript3 = "โรคหัดเยอรมัน : เกิดจากเชื้อไวรัสสามารถติดต่อได้ง่าย จากการสัมผัส เเละการหายใจร่วมกับผู้ป่วย ผู้ที่ติดเชื้อจะมีอาการปวดศีรษะ ปวดเมื่อย ไข้ต่ำๆ ตุ่มน้ำ";
            ...
            this.Cost1 = "เข็มละ 3,000–4,500 บาท";
            this.Cost2 = "เข็มละ 2,000–3,000 บาท";
          }
          else if (this.VacDetail.vaccode == "A011") {
            this.Descript = "โรคติดเชื้อโรต้า เกิดจากเชื้อไวรัส สามารถติดต่อจากการทานอาหารเเละน้ำดื่มที่มีเชื้อปนเปื้อน หรือสัมผัสสิ่งของที่มีเชื้อ โดยจะมีอาการปวดท้อง ท้องเสีย มีไข้อาเจียน เกิดภาวะขาดน้ำและเกลือแร่";
            this.Effect = "อาจมีอาการไข้ เบื่ออาหาร  อาเจียน งอแง";
            this.After = "ควรให้ยาลดไข้เเละเช็ดตัวด้วยน้ำอุณหภูมิห้อง ส่วนบริเวณที่บวมให้ใช้วิธีประคบเย็น";
            this.Cost1 = "เข็มละ 1,500-3,000 บาท";
            this.Cost2 = "เข็มละ 500-1,000 บาท";
          }
